...
/***/ function(module, exports, __webpack_require__) {
	...
	var TransactionList = React.createClass({displayName: "TransactionList",
		...
		componentDidMount: function() {
			console.log('go get some transactions!');
			/*
			$.ajax({
				method: 'GET',
				cache: false,
			...
			*/
			...
			.then(function(response) {
				...
				if (response.data.data && response.data.data.transactions) {
					this.setState({ transaction_list: response.data.data.transactions, all_data: response.data.data });
				} else {
					// need error/msg condition to show if no transactions available from server
		...
		filterData: function(e) {
			...
			var min_date;
			console.log('[filterData] filter value: ' + this.timeframe);
			...
			if (min_date) {
				var data = this.state.all_data.transactions.filter(function(TX) {
				...
				// show all
				this.setState({ transaction_list: this.state.all_data.transactions });
			}
		},
		...
		render: function(){
			...
			if (!this.state.transaction_list) {
				...
				var gData = []
					, Tx = JSON.parse(JSON.stringify(this.state.transaction_list))
	...
	//			  {columnName: 'payments',displayName: 'payments',customComponent: TxListPayments},
				...
				var gColumns = ['customer', 'cart', 'total_paid', 'ts', 'machine', 'sID']
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var ColumnProperties = __webpack_require__(178);
	var RowProperties = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var deprecatedMethod = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(39), (function() { return this; }()), __webpack_require__(177)(module)))
